...
- (void)viewDidLoad {
    ...
    _netWorksDic = @{
        ...
        @"Admob": @[@{@"Banner": @[@{@"320*50": @"260a7430-acd9-4dec-a4f2-e24a08855212"},
                                   @{@"300*250": @"260a7430-acd9-4dec-a4f2-e24a08855212"}]},
                    ...
                    @{@"MixView": @[@{@"banner320*50": @"381d5515-c86c-4e42-865b-d348e740ab6f"}]},
        ...
        @"AdGeneration": @[@{@"Banner": @[@{@"320*50": @"8544f540-bc56-4177-b4c8-6f4daf18e06c"},
                                          @{@"300*250": @"8544f540-bc56-4177-b4c8-6f4daf18e06c"}]},
                           @{@"Interstitial": @[@{@"interstitial" : @"e34bbdba-6c36-4d1e-a4a8-fe2c787b498b"}]},
                           @{@"Native": @[@{@"native": @"5b465d9f-dcba-47d2-81ae-3ace1e905f33"}]},
                           @{@"MixView": @[@{@"banner320*50": @"1d591af3-7184-49f6-a6d0-5eef158b8504"}]},
                           @{@"MixFullScreen":@[@{@"banner300*250" : @"babb0ddb-88b7-430c-be93-291ee223c52b"}]}],
        ...
        @"AppLovin": @[@{@"Banner": @[@{@"320*50": @"5a4ec11a-517b-47f5-86ce-a85b56fa8aea"},
                       ...
                       @{@"MixView": @[@{@"banner320*50": @"cbed7422-8ed8-4b24-b78e-009ec47aceda"}]},
        ...
        @"Baidu": @[@{@"Banner": @[@{@"320*50": @"482b2551-68fc-4f66-bcf7-34f6fd5886fa"},
                    ...
                    @{@"Native": @[@{@"native": @"fd1dfc46-1994-4dbc-b524-186aa69ddb9d"}]},
        ...
        @"DFP": @[@{@"Banner": @[@{@"320*50": @"74e81da4-e35d-4ab3-9594-49d45f31baef"},
                                 @{@"300*250": @"74e81da4-e35d-4ab3-9594-49d45f31baef"}]},
                  ...
                  @{@"MixView": @[@{@"banner320*50": @"d2ba90e3-8978-4a10-829e-a71d9f95c834"}]},
                  @{@"MixFullScreen":@[@{@"banner300*250" : @"43309363-b2e0-4674-9599-b428e80f30ca"}]}],
                    
        @"DisplayIO": @[@{@"Banner": @[@{@"320*50": @"cb4d50e6-c830-4d7e-b33c-db6040447fe9"}]},
                        @{@"Interstitial": @[@{@"interstitial" : @"9c870974-4b79-400b-9c06-77a43745e145"}]},
                        @{@"Native": @[@{@"native" : @"609f9bd6-dbd8-4571-ac3e-a3c1cfe62af7"}]},
        ...
        @"DU AD Platform": @[@{@"Banner": @[@{@"320*50": @"dddc68cd-3bb1-45d1-853d-7d5383e68fc7"}]},
                             ...
                             @{@"MixView":@[@{@"banner320*50": @"e442fde0-d698-4b79-a08b-6355c995fe7d"}]}],
        ...
        @"Facebook": @[@{@"Banner": @[@{@"320*50": @"90302de7-2d6e-4560-b6e7-1af5d567e72f"},
                       ...
                       @{@"MixView": @[@{@"banner320*50": @"ca00ab2c-ba60-49ff-99d5-048174178048"}]},
                       @{@"MixFullScreen":@[@{@"banner300*250" : @"2d99ffd0-2e55-4c82-b5d4-bc0a6c313cca"}]}],
        ...
        @"Flurry": @[@{@"Banner": @[@{@"320*50": @"9da72407-51f7-4e9e-8928-889696ece7e5"},
                     ...
                     @{@"MixView": @[@{@"banner320*50": @"7ffeef1b-06ac-4f40-b03a-9a22c9df0b7b"}]},
                     @{@"MixFullScreen":@[@{@"banner300*250" : @"7ffeef1b-06ac-4f40-b03a-9a22c9df0b7b"}]}],
        ...
        @"Fyber": @[@{@"Banner": @[@{@"320*50": @"34c9bbcb-50be-40aa-bd30-13ae100d8a6b"},
                    ...
                    @{@"MixView": @[@{@"banner320*50": @"1cba0098-813a-414d-a65c-c447410e0bcb"}]},
                    @{@"MixFullScreen":@[@{@"banner300*250" : @"812da3e9-cf5d-4edc-9697-149eaee05270"}]}],
                    
        @"GDT": @[@{@"Banner": @[@{@"320*50": @"522767ca-3d4f-4399-b654-ada7c06ed904"},
                                 @{@"300*250": @"522767ca-3d4f-4399-b654-ada7c06ed904"}]},
                  @{@"Interstitial": @[@{@"interstitial" : @"d978890e-23f4-4fe6-b415-f11f66270025"}]},
                  @{@"Native": @[@{@"native": @"54e45182-2b75-49ca-812d-ea3eea7387a3"}]},
                  @{@"RewardedVideo":@[@{@"RewardedVideo": @"b156abf1-2767-4073-a7a5-bdaf6026f032"}]},
                  @{@"FeedList":@[@{@"FeedList": @"803fea96-4403-44f7-9ec9-7e96a1a91a29"}]},
                  @{@"MixView": @[@{@"banner320*50": @"6bd66c4e-c520-4680-84e3-322abd85daf8"}]},
                  @{@"MixFullScreen":@[@{@"banner300*250" : @"db54e3df-6a1d-4189-90df-ee6b0e231e24"}]},
        ...
        @"Mopub": @[@{@"Banner": @[@{@"320*50": @"3e6c21ae-efe5-47f1-9118-ac43f9ece5c0"},
                    ...
                    @{@"MixView":@[@{@"banner": @"fdb2077c-cfec-4811-9138-1dd08ade3a7a"}]},
                    @{@"MixFullScreen":@[@{@"native": @"b1cd9895-b43c-466d-94fa-153064651c0f"}]}],
                    
        @"Mobvista": @[@{@"Banner": @[@{@"320*50": @"c1ba5bb5-ca70-4ff9-9fd6-7022625b8646"},
                                      @{@"300*250": @"c1ba5bb5-ca70-4ff9-9fd6-7022625b8646"}]},
                       @{@"Interstitial": @[@{@"interstitial" : @"c2ef033c-3405-4488-9148-50281962fed6"}]},
                       ...
                       @{@"MixView":@[@{@"banner": @"f4a20e31-c636-40f0-b172-2812a6a77b95"}]},
                       @{@"MixFullScreen":@[@{@"native": @"14ae5c8d-8e4b-4d69-a674-d2867ed5e4e1"}]}],
        ...
        @"Nend": @[@{@"Banner": @[@{@"320*50": @"3c570f15-17e7-49b6-b870-9e99e576d785"},
                   ...
                   @{@"Native": @[@{@"native": @"df6a54e9-5264-420b-81e4-e1a8cfbd601e"}]},
                   @{@"RewardedVideo":@[@{@"RewardedVideo": @"c4c74261-2976-4b33-8a98-ecb3f2a43e22"}]},
                   @{@"MixView":@[@{@"banner": @"792ca51d-de2e-4b79-84f0-a69411fdbe1f"}]},
                   @{@"MixFullScreen":@[@{@"native": @"323601f9-633f-49f2-b6e6-807117cb611d"}]}],
        ...
        @"Tiktok": @[@{@"Banner": @[@{@"320*50": @"f5e34294-4ce4-48fe-a400-6e3f1289c397"},
                     ...
                     @{@"RewardedVideo":@[@{@"RewardedVideo": @"c6907083-d63a-46a7-a5b8-3ebd46a6fc72"}]},
                     @{@"FeedList":@[@{@"FeedList": @"5a62d07f-ead0-4c0d-b503-aca2b87f99a6"}]},
                     @{@"MixView":@[@{@"banner": @"e0541bbb-c065-4659-9c56-8d9128ee116e"}]},
                     @{@"MixFullScreen":@[@{@"native": @"dff07570-c609-4752-b554-f303818c2199"}]},
                     @{@"Splash":@[@{@"splash" : @"2d5538a5-d686-4567-af9f-464dd3f2b956"}]}],
        ...
        @"Vungle": @[@{@"Banner": @[@{@"320*50" : @"e8fbe4f1-5fab-4abc-ba51-747f26246df1"}]},
